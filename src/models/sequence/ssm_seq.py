...
from flash_attention.flash_attn.modules.mha import MHA
from flash_attention.flash_attn.modules.mlp import Mlp, FusedMLP
from flash_attention.flash_attn.modules.block import Block
from flash_attention.flash_attn.modules.embedding import GPT2Embeddings
...
class SSMLMHeadModel(nn.Module, GenerationMixin):
    ...
    def load_state_dict(self, state_dict, strict=True):
        ...
        with open("h3_layer.txt", 'w') as wr:
